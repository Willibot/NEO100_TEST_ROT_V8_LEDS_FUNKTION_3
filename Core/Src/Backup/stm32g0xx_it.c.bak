...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define DEBOUNCE_TIME_MS 1000 // Entprellzeit von 1000 ms
/* USER CODE END PD */
...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
extern TIM_HandleTypeDef htim3; // Deklaration von htim3 aus main.c
static uint32_t last_interrupt_time = 0; // Für Entprellung
static uint32_t systick_counter = 0; // Für PA8 Toggle mit 500 Hz
/* USER CODE END PV */
